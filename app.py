...
model = tf.keras.models.load_model('skin_cancer_model_final.h5')
...
def upload():
    ...
    if file:
        try:
            ...
            predicted_description = make_prediction(file_path)
...
def get_health_blogs():
    ...
    india_schemes_laws_url = f'https://newsapi.org/v2/everything?q=health+India&apiKey={api_key}'
